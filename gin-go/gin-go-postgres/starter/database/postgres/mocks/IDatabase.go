...
func (_m *IDatabase) Count(ctx context.Context, model interface{}, total *int64, opts ...database.FindOption) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, interface{}, *int64, ...database.FindOption) error); ok {
...
func (_m *IDatabase) Delete(ctx context.Context, value interface{}, opts ...database.FindOption) error {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, interface{}, ...database.FindOption) error); ok {
...
func (_m *IDatabase) Find(ctx context.Context, result interface{}, opts ...database.FindOption) error {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *IDatabase) FindOne(ctx context.Context, result interface{}, opts ...database.FindOption) error {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
