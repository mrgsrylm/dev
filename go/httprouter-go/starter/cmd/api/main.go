...
import (
	...
	"github.com/mrgsrylm/ShaBank/goserver/internal/data"
	"github.com/mrgsrylm/ShaBank/goserver/internal/jsonlog"
	"github.com/mrgsrylm/ShaBank/goserver/internal/mailer"
	"github.com/mrgsrylm/ShaBank/goserver/internal/vcs"
...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", fmt.Sprintf("postgres://root:%s@localhost/shabank?sslmode=disable", pw), "PostgreSQL DSN")
	...
	mtPw := os.Getenv("MAILTRAP_PASSWORD")
	...
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "ShaBank <no-replay@shabank.io>", "SMTP sender")
